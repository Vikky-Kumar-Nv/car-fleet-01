...
const createDriver = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const driverData = Object.assign(Object.assign({}, data), { licenseExpiry: new Date(data.licenseExpiry), policeVerificationExpiry: new Date(data.policeVerificationExpiry), status: 'active' });
