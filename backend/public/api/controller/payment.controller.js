...
const createPayment = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = validation_1.paymentSchema.parse(req.body);
        // Service expects date present (IPayment.date). Supply if omitted.
        const payment = yield service.createPayment(Object.assign(Object.assign({}, data), { date: new Date() }));
...
const getPayments = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield service.getPayments(page, limit);
        res.json(result);
    }
    catch (e) {
        next(e);
