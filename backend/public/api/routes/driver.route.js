...
router.post('/', (0, middleware_1.auth)(['admin', 'dispatcher']), middleware_1.upload, controller.createDriver);
router.get('/', (0, middleware_1.auth)(['admin', 'dispatcher']), controller.getDrivers);
router.get('/:id', (0, middleware_1.auth)(['admin', 'dispatcher']), controller.getDriverById);
router.put('/:id', (0, middleware_1.auth)(['admin', 'dispatcher']), middleware_1.upload, controller.updateDriver);
